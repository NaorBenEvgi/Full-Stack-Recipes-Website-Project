<template>
  <div class="container">
    <h1 class="title subtitle">Register</h1>
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      >
        ...
        ></b-form-input>
        <b-form-invalid-feedback v-if="!$v.form.email.required">Last Name is required</b-form-invalid-feedback>
      ...
      >
        ...
        <b-form-invalid-feedback
          v-if="$v.form.password.required && !$v.form.password.isConatainsNumericChar"
        >must contains at least 1 numeric character</b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-if="$v.form.password.required && !$v.form.password.isConatainsSpecialChar"
      ...
      >
        <b-form-input
          id="profilePicURL"
          type="url"
          v-model="$v.form.profilePicURL.$model"
          :state="validateState('profilePicURL')"
        ></b-form-input>
        <b-form-invalid-feedback
          v-if="!$v.form.profilePicURL.required"
        >Profile Picture URL is required</b-form-invalid-feedback>
        <b-form-invalid-feedback
          v-else-if="!$v.form.profilePicURL.url"
        >invalid URL link</b-form-invalid-feedback>
      </b-form-group>
...
const isConatainsNumericChar = (value) => {
  const oneNumericChar = new RegExp("(?=.*[0-9])");
  return oneNumericChar.test(value);
};
const isConatainsSpecialChar = (value) => {
  ...
  validations: {
    form: {
      ...
      password: {
        ...
        isConatainsNumericChar,
        isConatainsSpecialChar
      },
      confirmedPassword: {
        required,
      ...
      try {
        const response = await this.axios.post(
          ...
          //"https://recipes-web-project.herokuapp.com/Register",
          {
            ...
            profilePic: this.form.profilePicURL
          }
        );
